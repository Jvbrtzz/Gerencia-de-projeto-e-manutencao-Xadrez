...
public class Queen : Piece
{
    ...
    public override Dictionary<Square, bool> LegalMovement(List<Square> possibleMovementSquares)
    {
        ...
        {
            if (IsSquareOnDiagonal(square) || IsSquareOnStraightLine(square))
            {
    ...
    bool IsSquareOnStraightLine(Square square)
    {
        return (square.row == currentSquare.row || square.column == currentSquare.column);
    }
